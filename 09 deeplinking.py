...
# async def callback_function_1(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
#     """Answers CallbackQuery with deeplinking url."""

#     await update.callback_query.answer(text=Hello)
...
def main() -> None:
    """Start the bot."""
    application = Application.builder().token("6653295841:AAGIP4GdaWiZGPOW-dfktXKPn82Ao9T3Kjw").build()
    ...
    # application.add_handler(CallbackQueryHandler(callback_function_1, pattern="1"))
    # application.add_handler(CallbackQueryHandler(callback_function_2, pattern="2"))
    # application.add_handler(CallbackQueryHandler(callback_function_3, pattern="3"))
